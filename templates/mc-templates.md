...
{% hint style="warning" %}
I did not make any of the plugins, mods, or server software in the templates, please see [this page](https://github.com/srnyx/mc-server-templates/wiki#sources) for sources.
{% endhint %}
